      ...
      <Container className="py-5 border-top ipad-class">
        ...
        {/* <Row>
          <Col className="mb-3" md={4}>
            <div className="profile-details">
              <img src={profileData?.image} alt="" />
              <h3>{capitalizeFirstLetter(profileData?.name)}</h3>
              <div className="pt-3">
                <h6>LinkdIn Profile :</h6>
          ...
          <Col md={8}>
            <div className="profile-desc">
              <div>
                <h4>My Aims</h4>
                <p>{capitalizeFirstLetter(profileData?.about)}</p>
              </div>
              <h4>About Me</h4>
              <Row>
                <Col md={3} xs={6} sm={6}>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.gender)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.matirialStatus)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.country)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.state)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.city)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.drinker)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.smoker)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.race)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.religion)}</p>
                  </div>
                </Col>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.politicalView)}</p>
                  </div>
                </Col>
              </Row>
              <h4>Professional</h4>
              <Row>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.skillLevel)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.companyName)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.industry)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.oftenPlay)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.availability)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
                ...
                <Col md={3} xs={6} sm={6}>
                  <div>
                    <p>{capitalizeFirstLetter(profileData?.purpose)}</p>
                  </div>
                </Col>
                <Col md={3} xs={6} sm={6}>
                  <div>
